...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Add Field to {{ $page->name }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('dynamic-fields.store') }}">
                        ...
                        <div class="mb-3" id="options-container" style="display: none;">
                            ...
                            <textarea class="form-control @error('options') is-invalid @enderror" id="options" name="options" rows="5" placeholder="Enter each option on a new line">{{ old('options') }}</textarea>
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input @error('is_unique') is-invalid @enderror" id="is_unique" name="is_unique" value="1" {{ old('is_unique') ? 'checked' : '' }}>
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input @error('is_searchable') is-invalid @enderror" id="is_searchable" name="is_searchable" value="1" {{ old('is_searchable', true) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input @error('is_sortable') is-invalid @enderror" id="is_sortable" name="is_sortable" value="1" {{ old('is_sortable', true) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input @error('is_visible') is-invalid @enderror" id="is_visible" name="is_visible" value="1" {{ old('is_visible', true) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <a href="{{ route('dynamic-pages.edit', $page) }}" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
